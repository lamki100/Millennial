...
<div id="center">
  <div>
    ...
    <form onsubmit='register(); return false'>
      <input type='text' style='text-transform: capitalize' placeholder='Full Name' spellcheck='false' autocomplete='off' maxlength='40' id='register-fullname'><input type='text' placeholder='Email' spellcheck='false' autocomplete='off' maxlength='40' id='register-email'><br>
